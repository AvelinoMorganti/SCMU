...
public class GPS extends Activity implements LocationListener {
    ...
    public void setGPS(View view) {
        AlertDialog.Builder dialog = new AlertDialog.Builder(GPS.this);
    ...
    public void localizarUsuario() {
        ...
        try {
            ...
            if (!provedorREDE_Habilitado && !provedorGPS_Habilitado) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GPS.this);
                alertDialogBuilder
    ...
    public void abreConfiguracaoDoDispositivo() {
        ...
        (GPS.this).startActivity(callGPSSettingIntent);
    }
